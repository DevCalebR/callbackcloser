      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-lg border bg-muted/30 p-4">
          <div className="flex items-start gap-3 text-sm text-muted-foreground">
            <input checked={false} className="mt-1 h-4 w-4 rounded border" disabled id="sms-consent-checkbox" name="consent" type="checkbox" />
            <span>
        ...
        <div className="rounded-lg border bg-background/80 p-4 text-sm text-muted-foreground">
          This public page is a compliance reference for buyers, carriers, and reviewers. It does not create a subscription, submit consent, or capture any
          phone number data by itself.
        </div>
      </CardContent>
    </Card>
  );
